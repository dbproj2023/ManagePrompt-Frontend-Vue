    ...
    <div>
        ...
        <div>
            ...
            <b-container class="bv-example-row" style="display: flex;">
                <div style="align-items: center;">
                    <b-row style="width: 1050px;">
                        <b-col style="display: flex;">
                            <b-form-datepicker class="input_date" v-model="inputDate" placeholder="투입일자" style="width:230px; margin-right: 5px;"  @input="handleDateInput"></b-form-datepicker>
                            ~
                            <b-form-datepicker class="output_date" v-model="outputDate" placeholder="탈출일자" style="width:230px; margin-left: 5px;"></b-form-datepicker>
                        </b-col>

                        <b-col  style="display: flex; ">
                            <div>
                                <select class="form-select form-control" style="width: 130px; height: 50px;" name="role" v-model="role" @change="onChange($event)">
                        ...
                        <b-col style="display: flex; align-items: center; ">
                            <div>
                                <b-form-input v-model="proName" placeholder="프로젝트명" style="width: 150px; height: 50px;"></b-form-input>
                            </div>
                        </b-col>

                        <b-col style="display: flex; align-items: center; ">
                            <div>
                                <b-form-input v-model="skill" placeholder="스킬" style="width: 150px; height: 50px;"></b-form-input>
                            </div>
                        </b-col>
                    </b-row>
                ...
                <b-row style="margin-top: 15px; width:500px; margin-left: 560px;">
                <b-col>
            ...
            <b-card no-body>
                <br>
                <hr>
                <el-table  v-if="filterByProj.length > 0" class="table-responsive table" header-row-class-name="thead-light" :data="employees">
...
export default {
    ...
    mounted() {
        const apiUrl = `${HOST}/api/v1/user/list`;
        const params = {
            period_start: "2022-01-01", 
            period_end:  "2023-05-23",
            role: "1",
            pro_id: "", 
            skill_name:"", 
            is_work: "1"};
